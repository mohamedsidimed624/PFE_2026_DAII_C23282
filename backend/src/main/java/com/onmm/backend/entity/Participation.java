...
@Entity
@Table(name = "sondage_participations", uniqueConstraints = {@UniqueConstraint(name = "uk_participation_sondage_repondant", columnNames = {"sondage_id", "repondant_hash"})})
public class Participation {
    ...
    public String getRepondantHash() {
        return repondantHash;
    }

    public void setRepondantHash(String repondantHash) {
        this.repondantHash = repondantHash;
    }
