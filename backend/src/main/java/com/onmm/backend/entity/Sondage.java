...
public class Sondage {
    ...
    public void setType(SondageType type) {
        this.type = type;
    }

    public SondageStatut getStatut() {
        return statut;
    }

    public void setStatut(SondageStatut statut) {
        this.statut = statut;
    }
    ...
    public String getFiltreSpecialite() {
        return filtreSpecialite;
    }

    public void setFiltreSpecialite(String filtreSpecialite) {
        this.filtreSpecialite = filtreSpecialite;
    }

    public String getFiltreWilaya() {
        return filtreWilaya;
    }

    public void setFiltreWilaya(String filtreWilaya) {
        this.filtreWilaya = filtreWilaya;
    }
    ...
    public String getFiltreGenre() {
        return filtreGenre;
    }

    public void setFiltreGenre(String filtreGenre) {
        this.filtreGenre = filtreGenre;
    }

    public boolean isResultatsPublies() {
        return resultatsPublies;
    }

    public void setResultatsPublies(boolean resultatsPublies) {
        this.resultatsPublies = resultatsPublies;
    }

    public Admin getCreePar() {
        return creePar;
    }

    public void setCreePar(Admin creePar) {
