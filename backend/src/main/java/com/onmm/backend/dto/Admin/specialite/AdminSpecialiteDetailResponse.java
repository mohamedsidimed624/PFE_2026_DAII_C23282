...
public class AdminSpecialiteDetailResponse {
    ...
    public List<AdminSousSpecialiteResponse> getSousSpecialites() { return sousSpecialites; }
    public void setSousSpecialites(List<AdminSousSpecialiteResponse> sousSpecialites) { this.sousSpecialites = sousSpecialites; }
}