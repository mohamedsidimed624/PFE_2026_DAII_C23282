...
\textit{Président : Dr.Mohamed El Moustapha EL ARBY} \\
\textit{Membre : Dr.Rifaa Sadegh, Dr.Med El Galy Beheitt, Dr.Ahmed Sejad} \\
\textit{Encadrant Pédagogique : Dr.Ahmed Sejad} \\
\textit{Encadrant Externe : Ing.Mohamed Saleck Elbechir}
\end{flushleft}
...
\paragraph{Anonymisation de l’électeur}\mbox{}
...
\paragraph{Confidentialité du bulletin de vote}\mbox{}
...
\paragraph{Protection des clés de chiffrement}\mbox{}
...
\paragraph{Vérification d’intégrité du bulletin}\mbox{}
...
\paragraph{Signature numérique des résultats}\mbox{}
...
\paragraph{Propriétés de sécurité obtenues}\mbox{}
...
\paragraph{Limites et perspectives d’amélioration}\mbox{}
...
% Renuméroter figures et tableaux en A.x pour l'annexe
...
\hline
Hugging Face &
\url{https://huggingface.co/Medsidi34} \\
\hline
\end{tabularx}
\caption{Profils professionnels en ligne}
\end{table}
...
\begin{figure}[H]
    ...
    \caption{Attestation de participation --- Bootcamp Intensif IA (FST / ICESCO, février 2026)}
\end{figure}

% -----------------------------------------------------------------
\medskip
\noindent{\large\bfseries A.4 \quad Stage Professionnel}
\medskip
...
\begin{figure}[H]
    ...
    \caption{Attestation de stage --- SMART-MS-SA, BU. Digital \& Factory (juin 2026)}
\end{figure}

% -----------------------------------------------------------------
\medskip
\noindent{\large\bfseries A.5 \quad Conférences et Événements Scientifiques}
\medskip
...
\hline
\end{tabularx}
\caption{Conférences auxquelles j'ai participé}
\end{table}

% -----------------------------------------------------------------
\medskip
\noindent{\large\bfseries A.6 \quad Compétitions}
\medskip
...
\hline
\end{tabularx}
\caption{Compétitions}
\end{table}

% -----------------------------------------------------------------
\medskip
\noindent{\large\bfseries A.7 \quad Engagement Associatif}
\medskip
