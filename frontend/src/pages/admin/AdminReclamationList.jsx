    ...
    <button
      ...
      className={cx(
        ...
        active
          ...
          : "border border-slate-200 bg-white text-slate-600 hover:border-green-300 hover:text-green-700 hover:bg-slate-50"
      )}
    >
      {children}
    </button>
        ...
        <div className="flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Consultez, filtrez et traitez les réclamations déposées.
            </p>
          </div>
  ...
  <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
    ...
    <div className="relative min-w-0 flex-1 xl:max-w-md">
      ...
      <input
        ...
        className="w-full rounded-xl border border-slate-200 bg-white py-2.5 pl-9 pr-8 text-sm outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-500/10"
      />
      {search && (
        <button
          onClick={() => setSearch("")}
    ...
    <div className="flex flex-col gap-3 sm:flex-row">
      <div className="relative">
        <select
          ...
          className="appearance-none rounded-xl border border-slate-200 bg-white py-2.5 pl-3 pr-8 text-sm text-slate-700 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-500/10"
        >
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {loading ? (
                  ...
                  paginated.map((r) => {
                    const isSubmitted =
                      (r.statut || "").toUpperCase() === "SUBMITTED";
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <button
                            onClick={() =>
                              navigate(`/admin/reclamations/${r.id}`)
                            }
                            className={cx(
